    ...
    <body>
    	<div id="wrapper" class="invoice">
    			...
    			<div id="companies">
    				<div class="seller">
    					...
    					<?php if ( ! empty( $owner['nip'] ) && ! $hideVatNumber ): ?>
    					   <p class="nip"><?php _e( 'VAT Number:', 'flexible-invoices' ); ?> <?php echo empty($owner['nip'])? '': $owner['nip']; ?></p>
    					<?php endif; ?>

					    <?php if ( $this->isSettingValue( 'bank_name' ) ): ?>
                            <p><?php _e( 'Bank:', 'flexible-invoices' ); ?> <?php echo empty($owner['bank'])? '': $owner['bank']; ?></p>
					    <?php endif; ?>

					    <?php if ( $this->isSettingValue( 'account_number' ) ): ?>
                            <p><?php _e( 'Account number:', 'flexible-invoices' ); ?> <?php echo empty($owner['account'])? '': $owner['account']; ?></p>
					    <?php endif; ?>
    		...
    		<?php if ( $invoice instanceof InvoicePostWoocommerce && $invoice->getAddOrderId() && $invoice->isOrder() ): ?>
			    ...
			    <p><?php _e( 'Order number:', 'flexible-invoices' ); ?> <?php echo $order->get_order_number(); ?></p>
			<?php endif; ?>
