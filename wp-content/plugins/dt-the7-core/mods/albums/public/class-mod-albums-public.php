...
class Presscore_Mod_Albums_Public {
	...
	public function register_shortcodes() {
		foreach ( array( 'albums', 'albums-jgrid', 'albums-slider', 'photos-masonry', 'photos-jgrid', 'photos-slider', 'gallery-masonry', 'photos-carousel', 'albums-masonry' ) as $shortcode_name ) {
